...
class View:
    def __init__(self, top=None):
        ...
        self.songName.configure(text='''Add Song to Play''')
    ...
    def setup_player(self):
        ...
        self.top.protocol("WN_DELETE_WINDOW",self.closewindow)
        self.isPaused = False
